...
class Booking
{
     ...
     * @Assert\GreaterThan(propertyPath="startDate", message="La date de départ doit ête plus éloignée que la date d'arrivée ")
     */
    private $endDate;
    ...
    {
        // Il faut connaître les date qui sont impossibles pour l'annonce
        ...
        // Tableau desc haînes de caractères de mes journées
    ...
    /**
     * Permet de récupérer un tableau des journée qui correspondent à ma réservation
     *
